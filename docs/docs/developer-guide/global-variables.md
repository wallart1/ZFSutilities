...
| `$preserve_target_holds`        | `'Y'` = before a full copy, capture existing holds on the destination and reapply them after the restore. Used by [zfsrestore](../commands-and-modules/commands.md#zfsrestore) and [zfsfullcopy](../commands-and-modules/commands.md#zfsfullcopy). Default `'Y'`                                                                                                                                                                                                         |
