...
ZFSUTILITIES_LOCK_DIR="${ZFSUTILITIES_LOCK_DIR:-/run/lock/zfsutilities}"
...
ZFSUTILITIES_SCRUB_STATE_PATH=\
"${ZFSUTILITIES_SCRUB_STATE_PATH:-${ZFSUTILITIES_STATE_DIR}/scrub_state.json}"
ZFSUTILITIES_NEXTSNAP_FILE="${ZFSUTILITIES_NEXTSNAP_FILE:-${ZFSUTILITIES_STATE_DIR}/nextsnap}"
ZFSUTILITIES_OFFSITE_NEXTSNAP_FILE=\
"${ZFSUTILITIES_OFFSITE_NEXTSNAP_FILE:-${ZFSUTILITIES_STATE_DIR}/nextsnap_offsite}"
ZFSUTILITIES_RUN_NEXTSNAP_PREFIX=\
"${ZFSUTILITIES_RUN_NEXTSNAP_PREFIX:-${ZFSUTILITIES_RUN_DIR}/nextsnap_}"
ZFSUTILITIES_SCRUBALL_STATEFILE=\
"${ZFSUTILITIES_SCRUBALL_STATEFILE:-${ZFSUTILITIES_RUN_DIR}/zfsscruball.state}"
...
ZFSUTILITIES_LEGACY_CONFIG_PATH=\
"${ZFSUTILITIES_LEGACY_CONFIG_PATH:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}/zfsutilities.json}"
ZFSUTILITIES_LEGACY_HISTORY_PATH=\
"${ZFSUTILITIES_LEGACY_HISTORY_PATH:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}/zfsutilities-history.json}"
ZFSUTILITIES_LEGACY_PROFILES_DIR=\
"${ZFSUTILITIES_LEGACY_PROFILES_DIR:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}/profiles}"
ZFSUTILITIES_LEGACY_SCRUB_STATE_PATH=\
"${ZFSUTILITIES_LEGACY_SCRUB_STATE_PATH:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}"\
"/zfsutilities/scrub_state.json}"
ZFSUTILITIES_LEGACY_NEXTSNAP_FILE=\
"${ZFSUTILITIES_LEGACY_NEXTSNAP_FILE:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}/zfsutilities_nextsnap}"
ZFSUTILITIES_LEGACY_OFFSITE_NEXTSNAP_FILE=\
"${ZFSUTILITIES_LEGACY_OFFSITE_NEXTSNAP_FILE:-${ZFSUTILITIES_LEGACY_CONFIG_HOME}"\
"/zfsutilities_offsite_nextsnap}"
...
ZFSUTILITIES_LEGACY_ISCSI_ENCRYPTED_CONF=\
"${ZFSUTILITIES_LEGACY_ISCSI_ENCRYPTED_CONF:-/etc/iscsi-encrypted-luns.conf}"
...
migrate_zfsutilities_state() {
    ...
    _migrate_path_item "$ZFSUTILITIES_OFFSITE_NEXTSNAP_FILE" \
        "$ZFSUTILITIES_LEGACY_OFFSITE_NEXTSNAP_FILE"

    # System administrator config files under /etc/zfsutilities/.
    _migrate_path_item "${ZFSUTILITIES_SYSTEM_CONFIG_DIR}/node.conf" \
        "$ZFSUTILITIES_LEGACY_NODE_CONF"
    _migrate_path_item "${ZFSUTILITIES_SYSTEM_CONFIG_DIR}/deploy.conf" \
        "$ZFSUTILITIES_LEGACY_DEPLOY_CONF"
    _migrate_path_item "${ZFSUTILITIES_SYSTEM_CONFIG_DIR}/iscsi-encrypted-luns.conf" \
        "$ZFSUTILITIES_LEGACY_ISCSI_ENCRYPTED_CONF"
    _migrate_path_item "${ZFSUTILITIES_SYSTEM_CONFIG_DIR}/two-node.conf" \
        "$ZFSUTILITIES_LEGACY_TWO_NODE_CONF"
